        ...
        feature: {
            mark: {
                ...
                title: {
                    ...
                    markUndo: 'Remove the help line',
                    markClear: 'Clear the auxiliary line'
                },
                lineStyle: {
                    width: 1,
                    color: '#1e90ff',
            ...
            dataView: {
                ...
                title: 'Data view',
                readOnly: false,
                lang: ['Data view', 'Shut down', 'Refresh']
            },
            magicType: {
                show: false,
                title: {
                    line: 'Line diagram switch',
                    bar: 'Column diagram switch',
                    stack: 'Accumulation',
                    tiled: 'Tiling',
                    force: 'Force orientation layout switch',
                    chord: 'Chord diagram switch',
                    pie: 'Pie chart switching',
                    funnel: 'Funnel map switch'
                },
                /*
                option: {
                    line: {},
