                ...
                <div class="modal-body" id="report_modal_body">
                    <div class="row" style="padding: 10px;">
                        <div class="col-md-12 form-group form-group-sm">
                            <div class="col-md-3"><b><s:text name="lbl.view"/></b></div>
                            <div class="col-md-6">
                        ...
                        <div class="col-md-12 mt-10" id="ReportViewDescDivId">
                            <div class="col-md-3" id="ReportViewDescId"><b><s:text name="lbl.description"/></b></div>
                            <%
        ...
        <div class="col-md-12 right-pad">
            <div class="dash-leads" style="border-top:0!important">
                ...
                <div class="my-bord bor2">
                    ...
                    <div class="col-sm-12 col-md-3 board-icons1 Rbtn">
                        <button class="btn btn-warning tmargin cbtn" style="width: 74px; margin-top: -8px" id="AddEnq" data-toggle="tooltip" data-placement="top" title="<s:text name="lbl.common.head.add.new.report"/>" onclick="addNewReport();" ><s:text name="btn.add"/></button>
                    </div>
                    <div class="">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <s:if test='#session.USER_INFO.userId.equals(repCrUid)'>
                                            <i class="fa fa-pencil hand" onclick="editSavedReports('<s:property value="#urRepSts.index" />', 'Edit');" title="Edit"></i>&nbsp;
                                        </s:if>
                                        &nbsp;&nbsp;
                                        <i class="fa fa-play hand" style="color: #418bca;" onclick="runSavedReports('<s:property value="#urRepSts.index" />');" ttitle="<s:text name="lbl.common.run"/>"></i>
                                        &nbsp;&nbsp;
